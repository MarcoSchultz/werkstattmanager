...
export default function MarkenVerwaltung() {
  ...
  const loeschen = async (id: string) => {
    const sicher = confirm(
      "Diese Fahrzeugmarke wirklich löschen? (Alle Modelle dieser Marke bleiben bestehen!)"
    );
    if (!sicher) return;
          ...
          {marken.length === 0 && (
            <tr>
              <td colSpan={2} className="p-4 text-center text-gray-500">
                Keine Fahrzeugmarken vorhanden
              </td>
            </tr>
          )}
        </tbody>
